...
\datatable{c|c|c|c}{\csvcoli & \csvcolii & \csvcoliii & \csvcoliv}{In serie geschaltet}{$U_{gemessen}$ & $I_{total}$ & $I_{1}$ & $I_{2}$}{b_lamp1.csv}{serie}

\circuit{
  (0, 0) to[vsource] (0, 5) to[lamp] (8, 5) to[rmeterwa, t=A, l=$I_{gemessen}$] (8, 0) -- (0, 0)
  (2, 5) -- (2, 6.5) to[rmeterwa, t=V, l=$U_{gemessen}$] (6, 6.5) -- (6, 5)
